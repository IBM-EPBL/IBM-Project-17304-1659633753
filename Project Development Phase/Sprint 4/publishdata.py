...
organization = "17rb95"
deviceType = "Info_Device"
deviceId = "Smart_Sign"
authMethod = "token"
authToken = "connectsign"

#Data List
Message_list = ["Crossing","School Zone","Hospital Zone","No Entry","One Way","Take Diversion"]
Traffic_list = ["High","Moderate","Low"]
Notify_list = ["Heavy Traffic","Heavy Rain","Bad Weather","Road Work Ahead","Accident Ahead"]

myLocation = "Chennai,IN"
APIKEY = "33f70e8a0b8b318ad16d3951c6ee700d"
