...
#define CROSSIN 4
#define CROSSOUT 15
#define Crossing 34 //Yellow Button
#define SchoolZone 35 //Black Button
#define HospitalZone 32 //White Button
#define NoEntry 25 //Gray Button
#define OneWay 26 //Green Button
#define TakeDiversion 27 //Red Button

void callback(char* subscribetopic, byte* payload, unsigned int payloadLength); 

//-------credentials of IBM Accounts------

#define ORG "17rb95"//IBM ORGANITION ID
#define DEVICE_TYPE "Info_Device"//Device type mentioned in ibm watson IOT Platform
#define DEVICE_ID "Road_Safety"//Device ID mentioned in ibm watson IOT Platform
#define TOKEN "connecttoiot"     //Token
String message;
int buttonState = 0,temp = 22,humid = 18,i=30;
